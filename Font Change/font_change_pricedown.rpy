...
init -1 style pricedown_bl is normal:
    font "C:/Users/vroom/Desktop/fonts/pricedown bl.ttf"
    size 24

init -1 style pricedown_bl is default_monika:
    font "C:/Users/vroom/Desktop/fonts/pricedown bl.ttf"
    size 24

init -1 python:
    style.hyperlink_text.font = "C:/Users/vroom/Desktop/fonts/pricedown bl.ttf"
    style.hyperlink_text.size = 24
...
init 6 python:
    def mas_enableTextSpeed():
        ...
        Enables text speed
        """
        style.say_dialogue = style.pricedown_bl
    ...
    def mas_disableTextSpeed():
        ...
        Disables text speed
        """
        style.say_dialogue = pricedown_bl
